<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <%@page import="Bean.AddExpense,java.util.* " %>
...
ArrayList <AddExpense> al=(ArrayList)session.getAttribute("s3");
Iterator <AddExpense> it=al.iterator();
while(it.hasNext())
 {
	AddExpense s=(AddExpense)it.next();
	 //out.println(s);
%>
...
%>
     ...
     <form action="DisplayExpense.jsp"> 
