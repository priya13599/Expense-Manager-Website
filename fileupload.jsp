...
function closeNav() {
    ...
    document.getElementById("main").style.marginLeft= "0";
	    ...
	    <div class="panel">
	        ...
	        <form  class ="modal-content" id="fileUploadForm" method="post" action="FileUploadServlet" enctype="multipart/form-data">
	            <div class="container">
	            <h1 style="color:white;text-align:center">ATTACH BILLS</h1>
    
      <hr>
      
	                <label style="color:white">Upload File</label><span id="colon">: </span><input id="fileAttachment" type="file" name="fileUpload" multiple="multiple" />
	                <span id="fileUploadErr" style="color:red">Please Upload A File!</span>
	            </div>
	            <div class="clearfix">
	            
	            <center> <button   style="background-color:white; color:black" class="signupbtn" id="uploadBtn" type="submit" class="btn btn_primary">Upload</button> </center>
	            </div>
	            <br>
	             <div class="panel">
