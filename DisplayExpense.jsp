...
function closeNav() {
    ...
    document.getElementById("main").style.marginLeft= "0";
     ...
     <form class="modal-content" action ="UserLoginServlet">
    <div class="container">
      <h1 style="color:white;text-align:center">Display Expenses</h1>
 ...
 <div class="clearfix">
        ...
        <input type="submit" class="signupbtn" value="DISPLAY" name ="c1"/>
      </div>
    </div>
